...
class ChatMessage extends StatefulWidget {
  ...
  ChatMessage(this.message, this.selectedOptions, this.screen);
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.message.type == Message.SEPARATOR_TYPE) {
      ...
      if (textMessage.length > 1) {
        return Container(
          padding: EdgeInsets.only(
              right: currentSliderIndex == textMessage.length - 1 ? 8.w : 0),
          child: Column(
            children: [
              CarouselSlider(
                  ...
                  return Builder(
                    builder: (BuildContext context) {
                      return Container(
                        ...
                        padding: EdgeInsets.fromLTRB(30.w, 30.h, 30.w, 20.sp),
                      ...
                      child: Padding(
                        ...
                        child: Stack(
                          children: [
                            CircleAvatar(
                              radius: 4.h,
                              backgroundColor: entry.key == currentSliderIndex
                                  ? Colors.white
                ...
                child: Column(
                    ...
                    children: <Widget>[
                      ...
                      if (widget.message.text != null &&
                        ...
                        //             "<html><head><meta name='viewport' content='width=device-width, initial-scale=1.0'></head><body>${textMessage[0].toString().replaceAll("Please ask another question or click 'Start Over'", "")}</body></html>",
                        //             mimeType: "text/html")
                        //         .toString(),
                        //   ),
                        // )
